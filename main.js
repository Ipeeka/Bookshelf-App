...
function save() {
  ...
  if (read.checked == true) {
    ...
    var id;
    bookList.length != 0 ? bookList.find((item) => (id = item.id)) : (id = 0);
    ...
    table.innerHTML += `
            <tr>
                ...
                <td><button class="btn btn-sm btn-warning" onclick="read(${
                  value.id
                },'${value.title}','${value.author}',${value.year})">
    ...
    table2.innerHTML += `
            <tr>
                ...
                <td><button class="btn btn-sm btn-warning" onclick="read2(${
                  value2.id
                },'${value2.title}','${value2.author}',${value2.year})">
                <i class="fa fa-check"></i>
                </button></td>
                <td>
                    <button class="btn btn-sm btn-success" onclick="find(${
...
// to find the data that will change 
